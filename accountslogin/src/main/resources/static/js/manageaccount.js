...
$( document ).ready(function() {
    ...
    var GridViewContainerID="accountGridViewContainer";
        ...
        var DataBindList=[
			{
				...
				OnDataBound:function(e){
					...
					return app.domain.repositories.search.filter("account","account_id IS NOT NULL"+ pkCondition);
				}
			}
		];
	    var GridView=app.controllers.ui.manageaccount.AccountGridViewControl.init({
